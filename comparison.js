...
const comparisonChart = function (ticker1Data, ticker2Data, investment){
  const startDate = Math.min(ticker1Data[1], ticker2Data[1]);
  const endDate = Math.max(ticker1Data[2], ticker2Data[2]);
  ...
  //   parsedData = ajaxResponse["history"]
  //     .reverse()
  ...
  // priceVariable = 'close';
  //
  // const metaData = ticker1Data["Meta Data"];
  //
  // //Chart dimensions
  ...
  // const units = investment ? (investment / parsedData[0][priceVariable]) : 1;
  //
  // // Scale
